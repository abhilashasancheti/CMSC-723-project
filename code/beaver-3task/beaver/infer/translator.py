...
def beam_search(opt, model, src, fields, flag):
    ...
    if flag:
        ...
        p1 = beam_search_1(opt, batch_size, src, fields["task2_tgt"], src_out, src_pad, model.task2_decoder, model.task2_generator)
        p2 = beam_search_1(opt, batch_size, src, fields["task3_tgt"], src_out, src_pad, model.task3_decoder, model.task3_generator)
        return p1, p2
