...
class Saver(object):
    ...
    def save(self, save_dict, step, loss_task1, loss_task2, loss_task3, bleu_task1, bleu_task2, bleu_task3, rouge1_task1, rouge1_task2, rouge1_task3, rouge2_task1, rouge2_task2, rouge2_task3):
