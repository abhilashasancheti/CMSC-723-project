...
def train_opts(parser):
    ...
    parser.add_argument("-patience", type=int, default=5, help="Number of iterations to check for early stopping")
    parser.add_argument("-max_iterations", type=int, default=1000000, help="Maimum number of iterations to train the model")
    parser.add_argument("-max_num_trial", type=int, default=3, help="Maximum number of trials before early stopping at a patience level")
